-- migrations/001_initial_schema.sql (FIXED)
...
-- Rejected shape removed: tickets.tags TEXT[] is not part of this migration.
-- Tag associations are modeled via the tags / ticket_tags tables above,
-- per the ERD's Tag and TicketTag entities.
